 ...
 *
 * MODULE INDEX
 * 1. BTF product Project Power data
...
/* ==========================================================================
   MODULE: BTF product Project Power data
   ========================================================================== */

(() => {
  "use strict";
  const projectPower = {"Project PowerVersion":"2026-08-09-fresh-rebuild-1","source":{"manufacturer":"BTF-LIGHTING","documents":["BTF-Lighting Addressable Pixel Strip Quotation List.pdf","BTF-Lighting FCOB Led Strip Price List.pdf"],"rules":"IP30 omitted; 24V-only/configurations omitted; cards grouped by product identity; FCOB middle-column parenthetical colors split into separate cards."},"totalItems":21,"categories":[{"id":"all","label":"All Products"},{"id":"Addressable Strips","label":"Addressable Strips"},{"id":"FCOB","label":"FCOB"}],"products":[{"id":"ws2812b-smd5050-rgb","category":"Addressable Strips","name":"WS2812B SMD 5050 RGB","subtitle":"Addressable Pixel Strip","description":"Input voltage: DC5V. LED Source: SMD 5050 RGB. IC Model: WS2812B. Individually addressable: each LED is separately controlled and 1 IC drives 1 LED. LED quantities offered in the source family: 30/60/100/144 LEDs per meter. PCB color: black or white. PCB width: 10mm for 30/60/100 LEDs and 12mm for 144 LEDs. Full-color RGB dream-color effects. Every LED is cuttable.","voltage":"5V","protection":"IP65 / IP67","image":"assets/Project Power/btf/addressable-group-001.webp","imageAlt":"BTF-LIGHTING WS2812B SMD 5050 RGB","variants":[{"item":2,"length":"1m","density":"100 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"1m 100 LEDs/m IP65 or IP67"},{"item":4,"length":"1m","density":"144 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"1m 144 LEDs/m IP65 or IP67"},{"item":6,"length":"2m","density":"100 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"2m 100 LEDs/m IP65 or IP67"},{"item":8,"length":"2m","density":"144 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"2m 144 LEDs/m IP65 or IP67"},{"item":10,"length":"5m","density":"30 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"5m 30 LEDs/m IP65 or IP67"},{"item":12,"length":"5m","density":"60 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"}],"tags":["ws2812b","smd5050","rgb","5v","ip65","ip67"],"source":"Addressable quotation items 1-12"},{"id":"ws2812b-eco-smd5050-rgb","category":"Addressable Strips","name":"WS2812B ECO SMD 5050 RGB","subtitle":"Addressable Pixel Strip - ECO","description":"Input voltage: DC5V. LED Source: SMD 5050 RGB. IC family: WS2812B ECO, identified in the source as the alloy-wire version. Individually addressable with one IC driving one LED. The family supports 30/60/144 LEDs per meter, black or white PCB, full-color RGB dream-color effects, and individual LED cutting.","voltage":"5V","protection":"IP65 / IP67","image":"assets/Project Power/btf/addressable-group-001.webp","imageAlt":"BTF-LIGHTING WS2812B ECO SMD 5050 RGB","variants":[{"item":14,"length":"1m","density":"144 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"1m 144 LEDs/m IP65 or IP67"},{"item":16,"length":"5m","density":"30 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"5m 30 LEDs/m IP65 or IP67"},{"item":18,"length":"5m","density":"60 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"}],"tags":["ws2812b eco","smd5050","rgb","5v","ip65","ip67"],"source":"Addressable quotation items 13-18"},{"id":"ws2811-smd5050-rgb-ordinary","category":"Addressable Strips","name":"WS2811 SMD 5050 RGB","subtitle":"Ordinary Type","description":"Input voltage: DC12V. LED Source: SMD 5050 RGB. IC Model: WS2811. External IC design with one IC controlling 3 LEDs. Full-color RGB dream-color effects. Source family offers 30/48/60/96/144 LEDs per meter, black or white PCB, with width varying by density. Three LEDs per cut segment.","voltage":"12V","protection":"IP65 / IP67","image":"assets/Project Power/btf/addressable-group-046.webp","imageAlt":"BTF-LIGHTING WS2811 SMD 5050 RGB","variants":[{"item":47,"length":"5m","density":"30 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 30 LEDs/m IP65 or IP67"},{"item":49,"length":"5m","density":"48 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 48 LEDs/m IP65 or IP67"},{"item":51,"length":"5m","density":"60 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"},{"item":53,"length":"5m","density":"96 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 96 LEDs/m IP65 or IP67"},{"item":55,"length":"5m","density":"144 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 144 LEDs/m IP65 or IP67"}],"tags":["ws2811","smd5050","ordinary","12v","ip65","ip67"],"source":"Addressable quotation items 46-55"},{"id":"ws2811-smd5050-rgb-bright","category":"Addressable Strips","name":"WS2811 SMD 5050 RGB","subtitle":"Bright Type","description":"Input voltage: DC12V. LED Source: SMD 5050 RGB. IC Model: WS2811. External IC design with one IC controlling 3 LEDs. Full-color RGB dream-color effects. Source family offers 30/48/60/96/144 LEDs per meter, black or white PCB, with width varying by density. Three LEDs per cut segment.","voltage":"12V","protection":"IP65 / IP67","image":"assets/Project Power/btf/addressable-group-046.webp","imageAlt":"BTF-LIGHTING WS2811 SMD 5050 RGB","variants":[{"item":57,"length":"5m","density":"30 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 30 LEDs/m IP65 or IP67"},{"item":59,"length":"5m","density":"48 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 48 LEDs/m IP65 or IP67"},{"item":61,"length":"5m","density":"60 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"},{"item":63,"length":"5m","density":"96 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 96 LEDs/m IP65 or IP67"},{"item":65,"length":"5m","density":"144 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 144 LEDs/m IP65 or IP67"}],"tags":["ws2811","smd5050","bright","12v","ip65","ip67"],"source":"Addressable quotation items 56-65"},{"id":"sk6812rgbw-smd5050-rgbw","category":"Addressable Strips","name":"SK6812RGBW SMD 5050 RGBW 4IN1","subtitle":"Addressable RGBW Pixel Strip","description":"LED Source: SMD 5050 RGBW 4IN1. IC Model: SK6812RGBW. Each LED is separately controlled and one IC drives one LED. Full-color RGBW dream-color effects with warm, natural, or cool white options. Black or white PCB depending on configuration; every LED is cuttable.","voltage":"5V / 12V","protection":"IP65 / IP67","image":"assets/Project Power/btf/addressable-group-070.webp","imageAlt":"BTF-LIGHTING SK6812RGBW SMD 5050 RGBW 4IN1","variants":[{"item":71,"length":"1m","density":"144 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"1m 144 LEDs/m IP65 or IP67"},{"item":73,"length":"5m","density":"30 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"5m 30 LEDs/m IP65 or IP67"},{"item":75,"length":"5m","density":"60 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"},{"item":77,"length":"5m","density":"60 LEDs/m","voltage":"12V","protection":"IP65","details":"5m 60 LEDs/m IP65"},{"item":78,"length":"5m","density":"60 LEDs/m","voltage":"12V","protection":"IP67","details":"5m 60 LEDs/m IP67"}],"tags":["sk6812rgbw","smd5050","rgbw","5v","12v","ip65","ip67"],"source":"Addressable quotation items 70-78"},{"id":"ws2815-smd5050-rgb","category":"Addressable Strips","name":"WS2815 SMD 5050 RGB","subtitle":"Dual-Signal Addressable Strip","description":"Input voltage: DC12V. LED Source: SMD 5050 RGB. IC Model: WS2815. Individually addressable with one IC per LED. Dual-signal design uses a main data wire and backup data wire so downstream LEDs can continue after a single LED failure. Full-color RGB dream-color effects; every LED is cuttable.","voltage":"12V","protection":"IP65 / IP67 / IP68","image":"assets/Project Power/btf/addressable-group-079.webp","imageAlt":"BTF-LIGHTING WS2815 SMD 5050 RGB","variants":[{"item":80,"length":"1m","density":"100 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"1m 100 LEDs/m IP65 or IP67"},{"item":82,"length":"1m","density":"144 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"1m 144 LEDs/m IP65 or IP67"},{"item":84,"length":"5m","density":"30 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 30 LEDs/m IP65 or IP67"},{"item":86,"length":"5m","density":"60 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"},{"item":87,"length":"5m","density":"60 LEDs/m","voltage":"12V","protection":"IP68","details":"5m 60 LEDs/m IP68"}],"tags":["ws2815","smd5050","rgb","12v","dual signal","ip65","ip67","ip68"],"source":"Addressable quotation items 79-87"},{"id":"ws2813-smd5050-rgb","category":"Addressable Strips","name":"WS2813 SMD 5050 RGB","subtitle":"Backup-Data Addressable Strip","description":"Input voltage: DC5V. LED Source: SMD 5050 RGB. IC Model: WS2813. Individually addressable with backup-data signaling for break-point continuous transmission. Full-color RGB dream-color effects, black or white PCB, and each LED is cuttable.","voltage":"5V","protection":"IP65 / IP67","image":"assets/Project Power/btf/addressable-group-088.webp","imageAlt":"BTF-LIGHTING WS2813 SMD 5050 RGB","variants":[{"item":89,"length":"1m","density":"100 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"1m 100 LEDs/m IP65 or IP67"},{"item":91,"length":"1m","density":"144 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"1m 144 LEDs/m IP65 or IP67"},{"item":93,"length":"5m","density":"30 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"5m 30 LEDs/m IP65 or IP67"},{"item":95,"length":"5m","density":"60 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"}],"tags":["ws2813","smd5050","rgb","5v","backup data","ip65","ip67"],"source":"Addressable quotation items 88-95"},{"id":"sk9822-smd5050-rgb","category":"Addressable Strips","name":"SK9822 SMD 5050 RGB","subtitle":"DATA + CLOCK Addressable Strip","description":"Input voltage: DC5V. LED Source: SMD 5050 RGB. IC Model: SK9822 (similar APA102). Each LED is individually addressable. Separate DATA and CLOCK signals provide a faster, more stable two-signal interface than a single data line. Full-color RGB dream-color effects.","voltage":"5V","protection":"IP65 / IP67","image":"assets/Project Power/btf/addressable-group-096.webp","imageAlt":"BTF-LIGHTING SK9822 SMD 5050 RGB","variants":[{"item":97,"length":"1m","density":"144 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"1m 144 LEDs/m IP65 or IP67"},{"item":99,"length":"5m","density":"30 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"5m 30 LEDs/m IP65 or IP67"},{"item":101,"length":"5m","density":"60 LEDs/m","voltage":"5V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"}],"tags":["sk9822","apa102","smd5050","rgb","5v","clock","ip65","ip67"],"source":"Addressable quotation items 96-101"},{"id":"tm1934-smd5050-rgb","category":"Addressable Strips","name":"TM1934 SMD 5050 RGB","subtitle":"Redundant-Signal Addressable Strip","description":"LED Source: SMD 5050 RGB. IC Model: TM1934. The 12V configuration uses an external IC controlling 3 LEDs. Dual-signal design includes main and backup data lines for break-point continuous transmission. Full-color RGB dream-color effects; black or white PCB.","voltage":"12V","protection":"IP65 / IP67","image":"assets/Project Power/btf/addressable-group-106.webp","imageAlt":"BTF-LIGHTING TM1934 SMD 5050 RGB","variants":[{"item":107,"length":"5m","density":"30 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 30 LEDs/m IP65 or IP67"},{"item":109,"length":"5m","density":"60 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"}],"tags":["tm1934","smd5050","rgb","12v","redundant signal","ip65","ip67"],"source":"Addressable quotation items 106-111; 24V configurations omitted"},{"id":"ws2814-smd5050-rgbw","category":"Addressable Strips","name":"WS2814 SMD 5050 RGBW 4IN1","subtitle":"RGBW Addressable Strip","description":"LED Source: SMD 5050 RGBW 4IN1. IC Model: WS2814. The 12V configuration uses an external IC controlling 3 LEDs. Full-color RGBW dream-color effects with warm or cool white. Black or white PCB depending on configuration.","voltage":"12V","protection":"IP65 / IP67 / IP68","image":"assets/Project Power/btf/addressable-group-112.webp","imageAlt":"BTF-LIGHTING WS2814 SMD 5050 RGBW 4IN1","variants":[{"item":113,"length":"5m","density":"30 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 30 LEDs/m IP65 or IP67"},{"item":115,"length":"5m","density":"60 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"},{"item":116,"length":"5m","density":"60 LEDs/m","voltage":"12V","protection":"IP68","details":"5m 60 LEDs/m IP68"},{"item":118,"length":"5m","density":"84 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 84 LEDs/m IP65 or IP67"},{"item":119,"length":"5m","density":"84 LEDs/m","voltage":"12V","protection":"IP68","details":"5m 84 LEDs/m IP68"}],"tags":["ws2814","smd5050","rgbw","12v","ip65","ip67","ip68"],"source":"Addressable quotation items 112-125; 24V configurations omitted"},{"id":"ws2805-smd5050-rgbcct","category":"Addressable Strips","name":"WS2805 SMD 5050 RGBCCT 5IN1","subtitle":"RGBCCT Redundant-Signal Strip","description":"LED Source: SMD 5050 RGBCCT 5IN1. IC Model: WS2805. The 12V configuration uses an external IC controlling 3 LEDs. Full-color RGBCCT dream-color output with tunable white from approximately 3000K to 6000K. Dual-signal design provides backup data transmission.","voltage":"12V","protection":"IP65 / IP67","image":"assets/Project Power/btf/addressable-group-126.webp","imageAlt":"BTF-LIGHTING WS2805 SMD 5050 RGBCCT 5IN1","variants":[{"item":127,"length":"5m","density":"60 LEDs/m","voltage":"12V","protection":"IP65 / IP67","details":"5m 60 LEDs/m IP65 or IP67"}],"tags":["ws2805","smd5050","rgbcct","12v","dual signal","ip65","ip67"],"source":"Addressable quotation items 126-131; 24V configurations omitted"},{"id":"fcob-solid-warm-white-ip65","category":"FCOB","name":"FCOB Solid White Warm White","subtitle":"IP65 Silicone Coated","description":"Voltage family: DC12V/24V; this Project Power retains the 12V configuration only. LED quantity: 480 or 528 LEDs/m. Wattage at 12V: 480 LEDs/m - 11W/m; 528 LEDs/m - 12W/m. FPCB width: 8mm for 480 LEDs/m and 10mm for 528 LEDs/m. White PCB. CRI >90, 180° view angle. Waterproof grade: IP65 silicone coating.","voltage":"12V","protection":"IP65","image":"assets/Project Power/btf/fcob-group-010.webp","imageAlt":"BTF-LIGHTING FCOB Solid White Warm White","variants":[{"item":10,"length":"5m","density":"480 LEDs/m","voltage":"12V","protection":"IP65","details":"Warm White - 5m 480 LEDs/m"},{"item":11,"length":"5m","density":"528 LEDs/m","voltage":"12V","protection":"IP65","details":"Warm White - 5m 528 LEDs/m"}],"tags":["fcob","solid white","warm white","12v","ip65"],"source":"FCOB quotation items 10-11"},{"id":"fcob-solid-natural-white-ip65","category":"FCOB","name":"FCOB Solid White Natural White","subtitle":"IP65 Silicone Coated","description":"Voltage family: DC12V/24V; this Project Power retains the 12V configuration only. LED quantity: 480 or 528 LEDs/m. Wattage at 12V: 480 LEDs/m - 11W/m; 528 LEDs/m - 12W/m. FPCB width: 8mm for 480 LEDs/m and 10mm for 528 LEDs/m. White PCB. CRI >90, 180° view angle. Waterproof grade: IP65 silicone coating.","voltage":"12V","protection":"IP65","image":"assets/Project Power/btf/fcob-group-010.webp","imageAlt":"BTF-LIGHTING FCOB Solid White Natural White","variants":[{"item":10,"length":"5m","density":"480 LEDs/m","voltage":"12V","protection":"IP65","details":"Natural White - 5m 480 LEDs/m"},{"item":11,"length":"5m","density":"528 LEDs/m","voltage":"12V","protection":"IP65","details":"Natural White - 5m 528 LEDs/m"}],"tags":["fcob","solid white","natural white","12v","ip65"],"source":"FCOB quotation items 10-11"},{"id":"fcob-solid-cold-white-ip65","category":"FCOB","name":"FCOB Solid White Cold White","subtitle":"IP65 Silicone Coated","description":"Voltage family: DC12V/24V; this Project Power retains the 12V configuration only. LED quantity: 480 or 528 LEDs/m. Wattage at 12V: 480 LEDs/m - 11W/m; 528 LEDs/m - 12W/m. FPCB width: 8mm for 480 LEDs/m and 10mm for 528 LEDs/m. White PCB. CRI >90, 180° view angle. Waterproof grade: IP65 silicone coating.","voltage":"12V","protection":"IP65","image":"assets/Project Power/btf/fcob-group-010.webp","imageAlt":"BTF-LIGHTING FCOB Solid White Cold White","variants":[{"item":10,"length":"5m","density":"480 LEDs/m","voltage":"12V","protection":"IP65","details":"Cold White - 5m 480 LEDs/m"},{"item":11,"length":"5m","density":"528 LEDs/m","voltage":"12V","protection":"IP65","details":"Cold White - 5m 528 LEDs/m"}],"tags":["fcob","solid white","cold white","12v","ip65"],"source":"FCOB quotation items 10-11"},{"id":"fcob-solid-yellow-white-ip67","category":"FCOB","name":"FCOB Solid White Yellow White","subtitle":"IP67 Waterproof","description":"Voltage family: DC12V/24V; this Project Power retains the 12V configuration only. LED quantity: 320 LEDs/m. Wattage at 12V: 7W/m. FPCB width: 10mm with black PCB. CRI >90, 180° view angle. Waterproof grade: IP67. Source color options: Yellow White 2700K, Warm White 3000K, Natural White 4000K, and Cold White 6000K.","voltage":"12V","protection":"IP67","image":"assets/Project Power/btf/fcob-group-013.webp","imageAlt":"BTF-LIGHTING FCOB Solid White Yellow White","variants":[{"item":13,"length":"5m","density":"320 LEDs/m","voltage":"12V","protection":"IP67","details":"Yellow White - 5m 320 LEDs/m"}],"tags":["fcob","solid white","yellow white","12v","ip67"],"source":"FCOB quotation item 13"},{"id":"fcob-solid-warm-white-ip67","category":"FCOB","name":"FCOB Solid White Warm White","subtitle":"IP67 Waterproof","description":"Voltage family: DC12V/24V; this Project Power retains the 12V configuration only. LED quantity: 320 LEDs/m. Wattage at 12V: 7W/m. FPCB width: 10mm with black PCB. CRI >90, 180° view angle. Waterproof grade: IP67. Source color options: Yellow White 2700K, Warm White 3000K, Natural White 4000K, and Cold White 6000K.","voltage":"12V","protection":"IP67","image":"assets/Project Power/btf/fcob-group-013.webp","imageAlt":"BTF-LIGHTING FCOB Solid White Warm White","variants":[{"item":13,"length":"5m","density":"320 LEDs/m","voltage":"12V","protection":"IP67","details":"Warm White - 5m 320 LEDs/m"}],"tags":["fcob","solid white","warm white","12v","ip67"],"source":"FCOB quotation item 13"},{"id":"fcob-solid-natural-white-ip67","category":"FCOB","name":"FCOB Solid White Natural White","subtitle":"IP67 Waterproof","description":"Voltage family: DC12V/24V; this Project Power retains the 12V configuration only. LED quantity: 320 LEDs/m. Wattage at 12V: 7W/m. FPCB width: 10mm with black PCB. CRI >90, 180° view angle. Waterproof grade: IP67. Source color options: Yellow White 2700K, Warm White 3000K, Natural White 4000K, and Cold White 6000K.","voltage":"12V","protection":"IP67","image":"assets/Project Power/btf/fcob-group-013.webp","imageAlt":"BTF-LIGHTING FCOB Solid White Natural White","variants":[{"item":13,"length":"5m","density":"320 LEDs/m","voltage":"12V","protection":"IP67","details":"Natural White - 5m 320 LEDs/m"}],"tags":["fcob","solid white","natural white","12v","ip67"],"source":"FCOB quotation item 13"},{"id":"fcob-solid-cold-white-ip67","category":"FCOB","name":"FCOB Solid White Cold White","subtitle":"IP67 Waterproof","description":"Voltage family: DC12V/24V; this Project Power retains the 12V configuration only. LED quantity: 320 LEDs/m. Wattage at 12V: 7W/m. FPCB width: 10mm with black PCB. CRI >90, 180° view angle. Waterproof grade: IP67. Source color options: Yellow White 2700K, Warm White 3000K, Natural White 4000K, and Cold White 6000K.","voltage":"12V","protection":"IP67","image":"assets/Project Power/btf/fcob-group-013.webp","imageAlt":"BTF-LIGHTING FCOB Solid White Cold White","variants":[{"item":13,"length":"5m","density":"320 LEDs/m","voltage":"12V","protection":"IP67","details":"Cold White - 5m 320 LEDs/m"}],"tags":["fcob","solid white","cold white","12v","ip67"],"source":"FCOB quotation item 13"},{"id":"fcob-cct-2700-6000k-ip65","category":"FCOB","name":"FCOB 2700K-6000K","subtitle":"IP65 Silicone Coated Tunable White","description":"Voltage family: DC12V/24V; this Project Power retains the 12V configuration only. LED quantity: 640 LEDs/m made from warm-white and cool-white channels. Wattage: 14W/m. FPCB width: 10mm, white or black PCB. Tunable CCT range: 2700K-6000K. CRI >90, 180° view angle. Waterproof grade: IP65 silicone coating.","voltage":"12V","protection":"IP65","image":"assets/Project Power/btf/fcob-group-016.webp","imageAlt":"BTF-LIGHTING FCOB 2700K-6000K","variants":[{"item":18,"length":"5m","density":"640 LEDs/m","voltage":"12V","protection":"IP65","details":"5m 640 LEDs/m, tunable 2700K-6000K"}],"tags":["fcob","cct","2700k","6000k","12v","ip65"],"source":"FCOB quotation item 18"},{"id":"fcob-spi-rgbic-addressable-ip66","category":"FCOB","name":"FCOB SPI RGBIC Addressable Type","subtitle":"WS2811 - IP66","description":"Voltage family: DC12V/24V; this Project Power retains the 12V configuration only. LED quantity: 864 LEDs/m. At 12V the strip is rated 12W/m. FPCB width: 12mm. IC Model: WS2811; 24 ICs/m, one IC controls 36 LEDs. RGBIC dream-color output. White PCB. Waterproof grade: IP66 heat-shrinkable sleeve.","voltage":"12V","protection":"IP66","image":"assets/Project Power/btf/fcob-group-048.webp","imageAlt":"BTF-LIGHTING FCOB SPI RGBIC Addressable Type","variants":[{"item":50,"length":"5m","density":"864 LEDs/m","voltage":"12V","protection":"IP66","details":"5m 864 LEDs/m IP66"},{"item":51,"length":"7.5m","density":"864 LEDs/m","voltage":"12V","protection":"IP66","details":"7.5m 864 LEDs/m IP66"}],"tags":["fcob","ws2811","rgbic","addressable","12v","ip66"],"source":"FCOB quotation items 48-51"},{"id":"fcob-spi-rgbw-addressable-ip66","category":"FCOB","name":"FCOB SPI RGBW IC Addressable Type","subtitle":"WS2814 - IP66","description":"Voltage: DC12V. LED quantity: 768 LEDs/m. Wattage: 18W/m. FPCB width: 10mm. IC Model: WS2814; 16 ICs/m with one IC controlling 48 LEDs. RGBW IC dream-color output with warm, natural, or cool white. Cutting length: 62mm. CRI >90, 180° view angle. Waterproof grade: IP66 heat-shrinkable sleeve.","voltage":"12V","protection":"IP66","image":"assets/Project Power/btf/fcob-group-060.webp","imageAlt":"BTF-LIGHTING FCOB SPI RGBW IC Addressable Type","variants":[{"item":61,"length":"5m","density":"768 LEDs/m","voltage":"12V","protection":"IP66","details":"5m 768 LEDs/m IP66"}],"tags":["fcob","ws2814","rgbw","addressable","12v","ip66"],"source":"FCOB quotation items 60-61"}]};
  window.SHYNETYME_BTF_ProjectPower = Project Power;
  window.SHYNETYME_BTF_READY = Promise.resolve(projectPower);
})();
...
(() => {
  ...
  const projectPowerPromise = Promise.resolve(window.SHYNETYME_BTF_ProjectPower || { products: [] });
  ...
  const buildProductMap = (items = []) => {
    ...
    Object.entries(legacyProjectPowerIds).forEach(([legacyId, currentId]) => {
  ...
  const recommendationEngine = async (type, selections, existing = {}) => {
    const [projectPower, sets] = await Promise.all([projectPowerPromise, setsPromise]);
    ...
    const productMap = buildProductMap(projectPower.products || []);
  ...
  const materialSummary = (draft) => {
    ...
    const productLines = selectedProducts.length
      ...
      : "- Exact Project Power rows will be finalized during consultation.";
    ...
    return [
      ...
      selectionLines,
      "",
      "Selected exact Project Power items:",
      productLines,
      "",
      "Project services:",
      supportLines,
  ...
  const writeContactDraft = async (draft = readDraft()) => {
    ...
    const projectPower = await projectPowerPromise;
    const productMap = buildProductMap(projectPower.products || []);
  ...
  const showBuildDecision = async () => {
    ...
    chuck.showChoices(
      "How about reviewing the exact Project Power items matched to your selections?",
      [
...
(() => {
  ...
  const installContactRequestFields = () => {
    ...
    section.innerHTML = `
      <section class="contact-project-details" aria-labelledby="contactProjectDetailsTitle">
        ...
        <div class="row g-3">
          ...
          <div class="col-12">
            <label class="form-label" for="Project PowerSelectionSummary">Selected Project Power systems</label>
            <textarea class="form-control contact-selection-summary" id="Project PowerSelectionSummary" name="Project Power_selections" rows="${project.length ? Math.min(14, Math.max(5, project.length * 3)) : 4}" readonly placeholder="Selections added from the BTF-LIGHTING project Project Power will appear here.">${selectionSummary}</textarea>
            <input id="Project PowerSelectionJson" name="Project Power_selection_json" type="hidden" value="">
          </div>
          <div class="col-12">
    ...
    const projectJson = section.querySelector("#Project PowerSelectionJson");
    ...
    form.addEventListener("submit", () => {
      ...
      message.value = `${message.value.trim()}\n\nSelected Project Power systems:\n${selectionSummary}`.trim();
    });
